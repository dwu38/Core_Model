...
// ReadParameterFile()
////////////////////////////////////////////////////////////////////////////
void clSeedlingsSurvival::ReadParameterFile( xercesc::DOMDocument * p_oDoc, clTreePopulation *p_oPop )
{
  try
  {
  ...
  catch ( ... )
  {
    ...
    stcErr.sFunction = "clSeedlingsSurvival::ReadParameterFile" ;
    throw( stcErr );
  }
}
...
// ValidateData
////////////////////////////////////////////////////////////////////////////
void clSeedlingsSurvival::ValidateData()
{
  try
  {
  ...
  {
    err.sFunction = "clSeedlingsSurvival::ValidateData";
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    stcErr.sFunction = "clSeedlingsSurvival::ValidateData" ;
    throw( stcErr );
  }
}
...
// DoMort
////////////////////////////////////////////////////////////////////////////
deadCode clSeedlingsSurvival::DoMort( clTree * p_oTree, const float & fDbh, const short int & iSpecies )
{
  clTreePopulation * p_oPop = ( clTreePopulation * ) mp_oSimManager->GetPopulationObject( "treepopulation" );
...
// GetBAT
////////////////////////////////////////////////////////////////////////////
float clSeedlingsSurvival::GetBAT(float &fX, float &fY, clTreePopulation *p_oPop)
{
