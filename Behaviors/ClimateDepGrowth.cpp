...
/////////////////////////////////////////////////////////////////////////////*/
float clClimateDepGrowth::CalcDiameterGrowthValue(clTree *p_oTree, clTreePopulation *p_oPop, float fHeightGrowth) {
  ...
  result = fPlotPrecip * mp_fPrecipSlope[mp_iIndexes[iSp]] + fPlotTemp * mp_fTempSlope[mp_iIndexes[iSp]] + fDiam * mp_fDBHSlope[mp_iIndexes[iSp]] + mp_fCdIntercept[mp_iIndexes[iSp]];
