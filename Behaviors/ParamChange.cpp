...
// Constructor
////////////////////////////////////////////////////////////////////////////////
clParamChange::clParamChange(clSimManager * p_oSimManager) : clWorkerBase(p_oSimManager), clBehaviorBase(p_oSimManager)
{
	try
	{
...
//	iNumSpecies = p_oPop->GetNumberOfSpecies();
	...
	for (i = 0; i < m_iNumBehaviorSpecies; i++) {
		...
		sQueryTemp << "species=" << mp_iWhatSpecies[i] << "::type=" << clTreePopulation::adult;
		...
		while( p_oTree )
		{
			...
			if (3 == iTp) {
				...
				p_oTree->GetValue(p_oPop->GetParamG1Code(iSp, iTp), &fParamG1);
				iNbSp ++;
				fMeanP1 += fParamG1;
			}
