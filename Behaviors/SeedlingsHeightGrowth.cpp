...
void clSeedlingsHeightGrowth::DoShellSetup( DOMDocument * p_oDoc ) {
  ...
  try {
    ...
    //Intercept
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightInter", "gr_shiVal",
    ...
    //Small seedlings
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightSm", "gr_shsmVal",
        p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
    ...
    //Medium seedlings
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightMd", "gr_shmdVal",
        p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
    ...
    //Large seedlings
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightLg", "gr_shlgVal",
        p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
    ...
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightJMxC", "gr_shjmxcVal",
        p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
    ...
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightPC", "gr_shpcVal",
        p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
    ...
    //Basal Area
    FillSpeciesSpecificValue(p_oElement, "gr_SeedlingsHeightBA", "gr_shbaVal",
        p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
...
// GetBAT
////////////////////////////////////////////////////////////////////////////
float clSeedlingsHeightGrowth::GetBAT(float &fX, float &fY, clTreePopulation *p_oPop)
{
...
//  fNewHeight = fHeight;
  ...
  fTransProb = 1 / ( 1 + exp ( - (mp_fInter[iSpecies] + fHEffect +
