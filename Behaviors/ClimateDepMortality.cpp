...
deadCode clClimateDepMortality::DoMort(clTree *p_oTree, const float &fDiam,
	...
	fSurvivalProb = exp(mp_fInter[mp_iIndexes[iSpecies]] + mp_fDiam[mp_iIndexes[iSpecies]] * fMortDiam + mp_fTemp[mp_iIndexes[iSpecies]] * fPlotClim1 + mp_fPrecip[mp_iIndexes[iSpecies]] * fPlotClim2);
