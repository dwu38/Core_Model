...
void clClimateNCIGrowth::DoShellSetup(xercesc::DOMDocument * p_oDoc) {
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_climatenciIntercept", "gr_cniVal", p_fTempValues,
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_climatenciDBHSlope", "gr_cndVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_climatenciNCISlope", "gr_cnnVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_climatenciPrecipSlope", "gr_cnpVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
