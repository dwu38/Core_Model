...
void clJanMinPrecipGrowth::DoShellSetup(xercesc::DOMDocument * p_oDoc) {
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_JanMinPrecipIntercept", "gr_JanMinPrecipiVal", p_fTempValues,
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_JanMinPrecipDBHSlope", "gr_JanMinPrecipdVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_JanMinPrecipNCISlope", "gr_JanMinPrecipnVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_JanMinPrecipJanMinSlope", "gr_JanMinPrecipjmnVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
  ...
  FillSpeciesSpecificValue( p_oElement, "gr_JanMinPrecipPrecipSlope", "gr_JanMinPrecippVal", p_fTempValues,
      m_iNumBehaviorSpecies, p_oPop, true );
  //Transfer to the appropriate array buckets
  for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
...
//        *p_fPrecipEffect;
  try
  {
	...
	fPlotJanMin = p_oPlot->GetJanMinTemp(), //Current plot April snow pack
        ...
        if (notdead == iIsDead) {
          ...
          for ( i = 0; i < fNumberYearsPerTimestep; i++ ) {
            ...
            fTempDiamIncrease = mp_fIntercept[iSpecies] + mp_fDBHSlope[iSpecies] * fDiam +
					...
					mp_fJanMinSlope[iSpecies] * fPlotJanMin +
