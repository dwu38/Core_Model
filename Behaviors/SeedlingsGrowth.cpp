...
void clSeedlingsGrowth::DoShellSetup( DOMDocument * p_oDoc )
{
  ...
  try
  {
    ...
    FillSpeciesSpecificValue( p_oElement, "gr_SeedlingsSm",
        "gr_SSmVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true );
    //Transfer values to our permanent array
    for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
    	mp_fSm[mp_iIndexes[p_fTempValues[i].code]] = p_fTempValues[i].val;

    // Medium seedlings parameter
    FillSpeciesSpecificValue( p_oElement, "gr_SeedlingsMd",
        "gr_SMdVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true );
    //Transfer values to our permanent array
    for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
    	mp_fMd[mp_iIndexes[p_fTempValues[i].code]] = p_fTempValues[i].val;

    // Large seedlings parameter
    FillSpeciesSpecificValue( p_oElement, "gr_SeedlingsLg",
        "gr_SLgVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true );
    //Transfer values to our permanent array
    for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
    	mp_fLg[mp_iIndexes[p_fTempValues[i].code]] = p_fTempValues[i].val;

    // July max parameter
    FillSpeciesSpecificValue( p_oElement, "gr_SeedlingsJMxC",
        "gr_SJMxCVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true );
    //Transfer values to our permanent array
    for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
      mp_fJMxC[mp_iIndexes[p_fTempValues[i].code]] = p_fTempValues[i].val;

    // Precip max parameter
    FillSpeciesSpecificValue( p_oElement, "gr_SeedlingsPC",
        "gr_SPCVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true );
    //Transfer values to our permanent array
    for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
      mp_fPC[mp_iIndexes[p_fTempValues[i].code]] = p_fTempValues[i].val;

    // Basal area max parameter
    FillSpeciesSpecificValue( p_oElement, "gr_SeedlingsBA",
        "gr_SBAVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true );
    //Transfer values to our permanent array
    for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
...
// GetBAT
////////////////////////////////////////////////////////////////////////////
float clSeedlingsGrowth::GetBAT(float &fX, float &fY, clTreePopulation *p_oPop)
{
...
/////////////////////////////////////////////////////////////////////////////*/
float clSeedlingsGrowth::CalcDiameterGrowthValue(clTree *p_oTree, clTreePopulation *p_oPop, float fHeightGrowth) {
