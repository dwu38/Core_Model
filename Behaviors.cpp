...
void clBehaviorManager::CreateBehavior(behaviorData * p_data)
{
  try
  {
    ...
    else if (p_data->sNameString.compare("ClimateSeedlingHeightSurvival diam only") == 0
        || p_data->sNameString.compare("ClimateSeedlingHeightSurvival") == 0)
    {
      clClimateSeedlingHeightSurvival * p_oGrowth = new clClimateSeedlingHeightSurvival(mp_oSimManager);
      mp_oObjectArray[iIndex] = p_oGrowth;
    }
...
//    else if (p_data->sNameString.compare("SeedlingsSurvival") == 0)
//    {
//      clSeedlingsSurvival * p_oMort = new clSeedlingsSurvival(mp_oSimManager);
//      mp_oObjectArray[iIndex] = p_oMort;
//    }
