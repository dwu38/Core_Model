...
class clPlot : virtual public clWorkerBase {
  ...
  */
   ...
   */
  float GetMeanAnnualTemp() {return m_fMeanAnnualTempC;};
   ...
   */
  float GetJulMaxTemp() {return m_fJMxTemp;};
   ...
   */
  float GetJanMinTemp() {return m_fJMnTemp;};
   ...
   * @return Annual snow.
   */
  float GetAnnualSnow() {return m_fSnow;};
   ...
   * @return Annual ASpck.
   */
  float GetASpck() {return m_fASpck;};
